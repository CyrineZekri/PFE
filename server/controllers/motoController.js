...
const deletemoto = async (req, res) => {
  try {
    const { id } = req.params;
    const car = await moto.findByIdAndDelete(id);
...
const setmotoIndisponibility = async (req, res) => {
  try {
    const { id } = req.params;
...
const deletemotoIndisponibility = async (req, res) => {
  try {
...
module.exports = {
  ...
  updatemoto,
  deletemoto,
  setmotoIndisponibility,
  getAllmotos,
  getmotoById,
  deletemotoIndisponibility
